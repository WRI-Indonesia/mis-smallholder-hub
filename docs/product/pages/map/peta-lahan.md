...
| Legenda hotspot | Legend | Breakdown per keyakinan deteksi + jumlah titik per kelas: `#b91c1c` Tinggi, `#f97316` Nominal, `#facc15` Rendah (kode VIIRS h/n/l; tak dikenal → Nominal; warna sengaja beda hue+lightness agar kontras); catatan "Deteksi anomali panas VIIRS 375 m, bukan konfirmasi kebakaran. Sumber: NASA FIRMS · jeda ±3 jam." |
