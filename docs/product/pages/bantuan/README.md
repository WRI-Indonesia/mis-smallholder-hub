...
| Aspek | Keterangan |
|---|---|
| Berkas materi | `src/content/help/` — lapis tutorial di `tutorial/` (28 file), lapis referensi di `referensi/` (4 file), lapis konsep di 6 folder `<n>-<bab>/<n>-<m>-<topik>.md` (12 file); total 12 bab di `CHAPTER_SOURCES` (5 tutorial + 1 referensi + 6 konsep) |
...
| 3 | tutorial | Memantau & Menindaklanjuti (`tutorial-memantau`) | Membaca dashboard dan peta, lalu mengubah temuannya jadi daftar kerja yang bisa ditindaklanjuti. | 3.1 Membaca Main Dashboard (`membaca-dashboard`) · 3.2 Menindaklanjuti petani yang belum dilatih (`cakupan-pelatihan`) · 3.3 Membaca peta lahan & peta BMP (`membaca-peta`) · 3.4 Membaca BMP Dashboard (produksi) (`dashboard-bmp`) · 3.5 Menjelajah Peta Lahan (`peta-lahan`) · 3.6 Memeriksa ketersediaan data (`ketersediaan-data`) · 3.7 Membaca Ringkasan Petani (`ringkasan-petani`) · 3.8 Membaca Metrik Rilis (`metrik-rilis`) |
