...
| 7 | konsep | Memulai (`memulai`) | Kenali istilah yang dipakai sistem, cara masuk, mengapa tampilan tiap pengguna berbeda, dan cara memakai Bantuan ini. | 7.1 Sekilas & Istilah Penting (`istilah`) · 7.2 Masuk & Akun (`masuk-akun`) · 7.3 Hak Akses & Cakupan Data (`hak-akses`) · 7.4 Cara Memakai Bantuan (`memakai-bantuan`) · 7.5 Peta Data (`peta-data`, #256) |
