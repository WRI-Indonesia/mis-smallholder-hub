...
📁 Master Data
   ├── ✅ Lembaga Tani (MD-02) — List/detail/CRUD
...
📤 Bulk Upload
   ...
   ├── 🔲 Bulk Upload Lembaga Tani (#69) — CSV + validation (belum ada menu/route)
