...
| Tanggal | Perubahan                                                                                                        |
| ------- | ---------------------------------------------------------------------------------------------------------------- |
| 06-30   | Master Data Kelompok Tani: Menampilkan total petani (kolom `Total Petani`), total persil lahan (kolom `Total Persil`), dan total luas lahan (kolom `Luas Lahan` dalam Ha) di masing-masing kelompok pada tabel daftar kelompok tani, mendukung sorting, dan menyertakan data ini pada saat mengekspor data ke Excel. |
