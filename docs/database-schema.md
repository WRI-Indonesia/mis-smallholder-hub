...
- `tbl_snapshot_production_dashboard` — Production analytics
- `tbl_snapshot_training_dashboard` — Training progress
- `tbl_snapshot_financial_dashboard` — Financial reports
...
- **Issue**: [#99 - DASH-01 Dashboard Snapshot](https://github.com/WRI-Indonesia/mis-smallholder-hub/issues/99)
- **Architecture Discussion**: [Issue #99 Comment](https://github.com/WRI-Indonesia/mis-smallholder-hub/issues/99#issuecomment-4827661498)
- **Implementation Pattern**: See `src/server/actions/snapshot.ts` for reference
