...
### SM-21 · Data Analyst › Ketersediaan Data — Semua Lembaga [P0] (2 mnt)
...
### SM-22 · Data Analyst › Ketersediaan Data — Per Lembaga [P0] (2 mnt)
Peran: SUPERADMIN, lalu OPERATOR · Langkah: pilih Lembaga (analisa otomatis), klik label sumbu radar → seksi, buka 1 baris checklist · Harapan: Index + radar + prioritas + checklist terisi; OPERATOR: Lembaga luar scope tidak ada.
