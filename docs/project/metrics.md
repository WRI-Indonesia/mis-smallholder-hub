...
| _(siklus berjalan)_ | — | 87,6% | — · 31/34 · 917 · 1 · 13 | 2422 | — | Siklus pasca-v0.26.0. Roadmap 87,4%→**87,6%**: **DASH-07 Fire Alert ✅ Done** (#266 — baseline 49→50 fase, inti ×2, 78/89). Bantuan 31/34 (menu baru `dashboard-risk-fire` langsung ber-tutorial `p-11`); test 896→**917**. RVS diisi saat rilis berikutnya |
