...
| _(siklus berjalan)_ | — | 87,6% | — · 31/34 · 925 · 4 · 13 | 2561 | — | Siklus pasca-v0.27.0. **#278** review kode pasca-rilis + Docs Compliance: 7 temuan kode & 4 dokumentasi diperbaiki (test 917→**923**). Bug open 2 → 6 → **4**: **#275** (`geojson` di-cast tanpa validasi) & **#274** (baris per boundary, bukan per lembaga) ditutup 2026-08-20 (test 923→**925**); sisa #237 + #270 lama, **#273 (priority: high, font berlisensi di repo publik — ditunda)**, #277. Roadmap & Bantuan dibawa dari rilis. RVS diisi saat rilis berikutnya |
