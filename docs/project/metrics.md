...
| _(siklus berjalan)_ | — | 86,1% | — · 30/30 · 808 · 1 · 13 | 1918 | — | Siklus pasca-v0.22.1 (terukur berjalan): Bantuan **30/30** (29/29 dari #207 + menu `bulk-upload-trees` #238 langsung ber-tutorial `u-4`); test 787 → **808** (50 file; +tree-upload & penjaga tutorial `u-4`); bug open 1 = #237 (Aktifkan kembali Menu Management). RVS belum dihitung — diisi saat rilis |
