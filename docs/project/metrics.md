...
| _(siklus berjalan)_ | — | 87,4% | — · 32/32 · 888 · 1 · 13 | 2269 | — | Siklus pasca-v0.25.0. #250 section Detail Roadmap + kolom Bobot & guard konsistensi roadmap↔metrics (±0,1 pp) + penyederhanaan layout Metrik Rilis; #256 **DA-07 Peta Data & Skema** (menu ke-32, cakupan Bantuan 32/32) → roadmap 87,1%→**87,4%** (48→49 fase, 76/87). Test 851→**888**. RVS diisi saat rilis berikutnya |
