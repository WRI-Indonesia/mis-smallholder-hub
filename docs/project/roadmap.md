...
- **Next step:** Maintain. Enum `NONE` sertifikasi (P3), bobot modul ke Index (P1 tahap 2), anomali nilai produksi → #178, tumpang tindih poligon → #317, perbaikan massal tanggal lahir tertukar (issue baru).
