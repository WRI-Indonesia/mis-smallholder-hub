...
| **🔨 #172 Detail Petani: profil 360° (pola #171)** | MD-03 | 🔨 In Progress | - | 2026-07-16 | Header (avatar placeholder TD-017 + link Lembaga #171 + KT/Gapoktan #152 + Edit) + 5 cards (Lahan+Luas, Produksi, Pelatihan n/paket, Kelengkapan Profil, Produktivitas terakhir) + Tabs: Ringkasan, Lahan (tabel + peta shared #171 + **PDF Profil Lahan #134**), Pelatihan (checklist paket + riwayat pre→post), Produksi (per tahun ber-persentase + bulanan collapsible + #166 + 4 kategori). Action `getFarmerDetail` RBAC + pure lib; ekstrak logika produksi & peta ke shared |
