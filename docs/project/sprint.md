...
| #154 Report Kelompok Tani (real-time): Lembaga×Gapoktan×KT + Total Petani/Lahan | RPT | 🔲 Todo | TBD | TBD | `getKelompokTaniReport` real-time (scoped, normalisasi) + menu/route/summary/tabel + Excel/PDF. Read-only. Depends #146 + data (#150) |
