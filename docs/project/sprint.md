...
| #153 Master Lembaga Tani: KT/Gapoktan/Blok turunan (snapshot-backed) | MD-04 | 🔲 Todo | TBD | TBD | **Snapshot-backed (Opsi A: perluas `MainDashboardSnapshot` via Tools)** — kolom Jumlah KT/Gapoktan/Blok di list Lembaga baca snapshot terakhir. Detail per-record real-time (#152). Depends #146 + data (#150) |
