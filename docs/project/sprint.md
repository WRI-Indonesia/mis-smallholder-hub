...
| **🔨 #171 Detail Lembaga Petani: profil 360° (Fase 1)** | MD-02 | 🔨 In Progress | - | 2026-07-16 | Header (badge sertifikasi + Edit) + 5 summary cards (Petani L/P, KT/Gapoktan, Persil+Luas, Produksi, skor DA-02 card+link) + Tabs: Ringkasan (profil + struktur #154), Pelatihan (cakupan + aktivitas + pre/post), Produksi (per tahun + produktivitas #166 + 4 kategori MAP-02); tab Petani/Lahan ringkas (Fase 2 pending — data belum memadai). Real-time, action `getFarmerGroupDetail` RBAC 3 lapis |
