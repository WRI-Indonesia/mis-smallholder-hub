...
+ Pilihan **Sheet per** di sebelah tombol Excel menentukan pecahan sheet: **Grid peta** (bawaan — satu sheet per sel grid, ber-gambar peta), **Kelompok Tani** (satu sheet per KT), atau **Blok** (satu sheet per `KT – Blok`, karena nama Blok bisa sama di KT berbeda). Sheet KT/Blok berisi tabel saja, tanpa gambar peta, dan punya baris Total sendiri; lahan tanpa KT/Blok masuk sheet **Tanpa KT** / **Tanpa Blok**. Sheet **Lahan** tetap berisi seluruh baris. Pilihan ini tidak memengaruhi PDF.
