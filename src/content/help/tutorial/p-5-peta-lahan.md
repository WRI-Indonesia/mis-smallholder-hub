...
+ Provinsi dan Lembaga Petani opsional untuk mempersempit — pilih **Semua Provinsi**/**Semua Lembaga Petani** di puncak daftarnya untuk membatalkan pilihan. Tombol Muat Data tetap nonaktif sampai Distrik dipilih. Di bawah Muat Data ada tombol **Unduh Lahan** untuk membawa poligon lahan keluar sebagai Shapefile/GeoJSON/KML (hanya tampil bila punya izin **Export**) — lihat tutorial **Mengunduh data spasial lahan**. Setelah data dimuat, tiap baris **Legenda** juga punya ikon unduh sendiri (Excel, atau Shapefile/GeoJSON/KML sesuai bentuk barisnya — titik atau poligon), termasuk baris **Patok lahan**.
...
4. Klik sebuah poligon untuk membuka info detailnya — lahan yang sedang terbuka popup-nya **disorot kuning bergaris tebal** supaya tak tertukar dengan tetangganya.
+ Popup bisa **digeser**: tarik pegangan abu kecil di puncak kartu bila popup menutupi lahan yang sedang Anda amati. Popup tetap menempel pada lahannya saat peta digeser atau di-zoom, dan posisinya kembali normal setiap kali Anda membuka lahan lain. Sorotan kuning tetap tampil meski lapisan **Area Lahan** dimatikan. Popup berisi identitas petani, luas, komoditas, status NKT, jumlah **patok** yang tertaut ("4 patok" / "Belum ada patok" — titiknya sendiri ada di lapisan Patok, pengelolaannya di tab Patok halaman Detail Lahan), dan data produksi bila ada. Dari popup ini Anda bisa mencetak **Profil Lahan** (PDF, biasanya 2 halaman: kartu ringkasan, layout lahan dengan lahan tetangga dalam 25 m bergaris putus-putus bernomor + legendanya, informasi & pemilik, sepadan, Legalitas & Dokumen — surat kepemilikan, STDB, UL Parcel Code, program — lalu pelatihan dan produksi; hanya tampil bila punya izin **Print**), membuka **Lihat Detail** halaman lahan (terbuka di tab baru, jadi posisi peta Anda tidak hilang), atau **Edit Lahan** langsung dari peta bila akun Anda punya izin ubah pada menu Lahan. Perubahan mengikuti mekanisme revisi biasa, dan peta ikut menyegar setelah disimpan. Tombol yang sama tersedia di popup **Sebaran Lahan** (di detail Lembaga Petani/Petani) dan **Peta BMP**.
...
7. Untuk tampilan **3D**: tekan tombol **gunung** (Terrain 3D) di kanan bawah — peta otomatis dimiringkan dan relief permukaan (DEM AWS Terrain Tiles) ikut tergambar; tekan lagi untuk mematikannya. Di bawahnya ada kotak **putar kiri/kanan** (30° per klik) dan **miringkan/tegakkan** (15° per klik) — pengganti drag kanan / Ctrl+drag.
+ Tombol **kompas** (panah) selalu menunjuk utara sebenarnya dan menyala hijau bila peta sedang diputar/miring; klik untuk **kembali ke utara & tampilan 2D**. Dataran Riau landai sehingga relief 3D memang halus — paling terasa di tepi bukit/lembah sungai.
