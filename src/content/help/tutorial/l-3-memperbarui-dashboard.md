...
+ Keduanya terpisah dan tidak saling memperbarui. Setelah unggah produksi besar, yang perlu dibuat ulang adalah snapshot BMP — beserta hal-hal yang khusus berlaku di sana (cakupan pembuat, menelusuri rekaman lama) dibahas di [Membuat & menelusuri Snapshot BMP](/admin/help/tutorial-laporan/snapshot-bmp).
