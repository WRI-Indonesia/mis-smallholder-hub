...
**Mengubah & melihat detail** — Kolom Aksi di kiri baris berisi tombol ubah dan detail. Halaman detail Petani dan Lembaga Petani menampilkan profil lengkap: lahan dan peta (tab Lahan petani juga meringkas surat kepemilikan dan STDB tiap lahan), pelatihan, serta produksi. Halaman detail Lahan menampilkan kartu ringkasan (luas + jumlah pohon, legalitas, umur tanaman, produksi, kelengkapan data) lalu tiga tab — **Informasi** (peta batas kebun berlabel — hijau lahan ini, biru lahan lain milik petani yang bisa diklik untuk melihat ringkasan dan membuka detailnya — dengan koordinat titik pusat, atribut yang terisi dan daftar yang belum diisi dengan tombol Lengkapi, pemilik), **Legalitas** (surat kepemilikan dengan luas tertera vs luas poligon, STDB beserta lahan lain yang ditutupnya, kode pemetaan vendor, dan program seperti demplot PBU — diisi lewat Bulk Upload → Lahan → tab Detail Lahan, atau ditambah/diubah langsung di tab itu sesuai izin), dan **Produksi** (grafik dan tabel bulanan), serta tombol unduh PDF Profil Lahan (kini memuat pula bagian Legalitas & Dokumen); sel bulan pada tabel produksi bisa diklik untuk menambah atau mengubah data panen bulan itu (maks. 4 panen per bulan, mengikuti izin menu Data Produksi).
