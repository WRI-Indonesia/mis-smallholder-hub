...
**Ketersediaan Data — Semua Lembaga** — Pintu masuk untuk pertanyaan "lembaga mana yang datanya paling belum lengkap, dan jenis kekurangan apa yang paling banyak". Isinya skor kelengkapan 0–100 per lembaga untuk lima domain (Profil Lembaga, Petani, Lahan, Pelatihan, Produksi): hero berisi cincin Skor Keseluruhan, distribusi lembaga per band (bisa diklik untuk menyaring), dan tiga aksi lintas lembaga; lima kartu domain berskor (klik untuk mengurutkan matriks); *Radar* per lembaga (bawaan: satu pentagon lima domain per lembaga — bentuknya yang dibaca) dengan pilihan tampilan *Heatmap* (tabel lembaga × domain, sel diwarnai mengikuti skor) dan *Cakupan modul* (lembaga × modul), plus kotak cari; daftar *paling tertinggal per domain*; panel Anomali Terbanyak yang memisahkan anomali *per entitas* dari *kolom yang belum pernah diisi*; dan ekspor Excel. Klik nama lembaga untuk melompat ke halaman Per Lembaga. Warna skor: hijau tua khusus 100 (lengkap penuh), hijau 80 – <100, kuning 50 – <80, merah <50. Angkanya dihitung langsung saat halaman dibuka (bukan snapshot). Perlu diingat: skor rendah berarti datanya belum tercatat, belum tentu kondisi lapangannya buruk.

**Ketersediaan Data — Per Lembaga** — Rincian satu lembaga sampai ke daftar kerja: angka Index + radar lima domain (klik nama sumbu untuk membuka seksinya; bobot tiap domain tertulis di judul seksi), cakupan modul tambahan (surat tanah, STDB, NKT, patok, pohon, Monev BMP, boundary, acuan — informatif, di luar Index), lalu temuan anomali per domain dengan tautan ke Detail Petani/Detail Lahan dan petunjuk *Perbaiki lewat* menu mana. Analisa berjalan otomatis begitu lembaga dipilih. Skornya identik dengan halaman Semua Lembaga karena memakai perhitungan yang sama; rumusnya ada di Referensi → *Ketersediaan Data — cara skor dihitung*.
