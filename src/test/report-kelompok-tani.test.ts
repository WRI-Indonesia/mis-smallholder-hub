...
describe("buildKelompokTaniReport", () => {
  it("mengelompokkan per (Lembaga × KT) dengan distinct petani & jumlah lahan", () => {
    const r = buildKelompokTaniReport([
      P({ farmerId: "f1", farmerGroupId: "lg1", subGroupLv2: "KT A" }),
      P({ farmerId: "f1", farmerGroupId: "lg1", subGroupLv2: "KT A" }), // f1 lahan ke-2
      P({ farmerId: "f2", farmerGroupId: "lg1", subGroupLv2: "KT A" }),
      P({ farmerId: "f3", farmerGroupId: "lg1", subGroupLv2: "KT B" }),
    ]);
  ...
  it("KT null tetap muncul sebagai baris tersendiri", () => {
    const r = buildKelompokTaniReport([
      P({ farmerId: "f1", farmerGroupId: "lg1", subGroupLv2: null }),
      P({ farmerId: "f2", farmerGroupId: "lg1", subGroupLv2: "KT Y" }),
    ]);
    expect(r.rows).toHaveLength(2);
  ...
  it("summary: distinct Lembaga/KT/petani + total lahan", () => {
    const r = buildKelompokTaniReport([
      P({ farmerId: "f1", farmerGroupId: "lg1", lembagaTani: "L1", subGroupLv2: "KT1" }),
      P({ farmerId: "f2", farmerGroupId: "lg1", lembagaTani: "L1", subGroupLv2: "KT2" }),
      P({ farmerId: "f3", farmerGroupId: "lg2", lembagaTani: "L2", subGroupLv2: "KT3" }),
      P({ farmerId: "f1", farmerGroupId: "lg1", lembagaTani: "L1", subGroupLv2: "KT1" }), // f1 lagi
    ]);
